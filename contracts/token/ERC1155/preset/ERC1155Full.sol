...
contract ERC1155Full is ERC1155, ERC1155Metadata, ERC1155Mintable, ERC1155Deliverable, ERC2981, TokenRecovery, ForwarderRegistryContext {
    constructor(
        string memory tokenName,
        string memory tokenSymbol,
        ITokenMetadataResolver metadataResolver,
        IForwarderRegistry forwarderRegistry
    ) ContractOwnership(msg.sender) ERC1155Metadata(tokenName, tokenSymbol, metadataResolver) ERC1155() ForwarderRegistryContext(forwarderRegistry) {}
