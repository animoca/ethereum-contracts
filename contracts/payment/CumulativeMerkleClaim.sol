...
/// @notice unclaimed payouts and the new payouts, per user. The new tree is set and replaces the previous one, then the contract can be unpaused.
...
abstract contract CumulativeMerkleClaim is Pause {
    ...
    /// @notice Sets the merkle root for a new claing period.
