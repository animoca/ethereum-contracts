...
const name = 'ERC721FullMintOnceBurn';
const symbol = 'ERC721FullMintOnceBurn';

const config = {
  immutable: {
    name: 'ERC721FullMintOnceBurnMock',
    ctorArguments: ['name', 'symbol', 'metadataResolver', 'forwarderRegistry'],
    testMsgData: true,
  },
  proxied: {
    name: 'ERC721FullMintOnceBurnProxiedMock',
...
runBehaviorTests('ERC721FullMintOnceBurn', config, function (deployFn) {
  const implementation = {
    ...
    errors: {
      ...
      // ERC721MintableOnce
      BurntToken: {custom: true, error: 'ERC721BurntToken', args: ['tokenId']},
